...
def GUII(List,integer_rsi,integer_rti,rsi,rti,offset) :
    win2=GraphWin("miniatureI",1510,830)
    ...
    Line(Point(50,450),Point(25,450)).draw(win2)
    Line(Point(25,450),Point(25,40)).draw(win2)

    #output line pc instruction memory ok shod
    Line(Point(100,450),Point(190,450)).draw(win2)

    #output line pc multiplexer1 faz1
    Line(Point(150,450),Point(150,120)).draw(win2)

    #output line faz1 adder1
    Line(Point(150,120),Point(200,120)).draw(win2)
    Line(Point(150,100),Point(200,100)).draw(win2)
    ...
    rectInstxt1.draw(win2)

    #faz3 register file
    Line(Point(400,450),Point(430,450)).draw(win2)
    Line(Point(430,450),Point(430,350)).draw(win2)  #avale shakhe1
    Line(Point(430,350),Point(480,350)).draw(win2)  #shakhe 1         #rs
    ...
    rsIn.setSize(8)
    rsIn.draw(win2)
    Line(Point(430,450),Point(480,450)).draw(win2)  #shakhe2          #rt
    ...
    rtIn.setSize(8)
    rtIn.draw(win2)
    Line(Point(430,450),Point(430,550)).draw(win2)  #avale shakhe3
    ...
    if integer_rsi == 0:
        rectReg0txt=Text(Point(610,310),rsi)
    elif integer_rti == 0:
        rectReg0txt=Text(Point(610,310),rti)
#    elif integer_rdr == 0:
#        rectReg0txt=Text(Point(610,310),rdr)
    else :
        rectReg0txt=Text(Point(610,310),' ')
    rectReg0txt.setSize(8)
    rectReg0txt.draw(win2)
    ...
    if integer_rsi == 1:
        rectReg1txt=Text(Point(610,330),rsi)
    elif integer_rti == 1:
        rectReg1txt=Text(Point(610,330),rti)
#    elif integer_rdr == 1:
#        rectReg1txt=Text(Point(610,330),rdr)
    else :
        rectReg1txt=Text(Point(610,310),' ')
    rectReg1txt.setSize(8)
    rectReg1txt.draw(win2)
    ...
    if integer_rsi == 2:
        rectReg2txt=Text(Point(610,350),rsi)
    elif integer_rti == 2:
        rectReg2txt=Text(Point(610,350),rti)
#    elif integer_rdr == 2:
#        rectReg2txt=Text(Point(610,350),rdr)
    else :
        rectReg2txt=Text(Point(610,350),' ') 
    rectReg2txt.setSize(8)
    rectReg2txt.draw(win2)
    ...
    if integer_rsi == 3:
        rectReg3txt=Text(Point(610,370),rsi)
    elif integer_rti == 3:
        rectReg3txt=Text(Point(610,370),rti)
#    elif integer_rdr == 3:
#        rectReg3txt=Text(Point(610,370),rdr)
    else :
        rectReg3txt=Text(Point(610,370),' ')
    rectReg3txt.setSize(8)
    rectReg3txt.draw(win2)
    ...
    if integer_rsi == 4:
        rectReg4txt=Text(Point(610,390),rsi)
    elif integer_rti == 4:
        rectReg4txt=Text(Point(610,390),rti)
#    elif integer_rdr == 4:
#        rectReg4txt=Text(Point(610,390),rdr)
    else :
        rectReg4txt=Text(Point(610,390),' ')
    rectReg4txt.setSize(8)
    rectReg4txt.draw(win2)
    ...
    if integer_rsi == 5:
        rectReg5txt=Text(Point(610,410),rsi)
    elif integer_rti == 5:
        rectReg5txt=Text(Point(610,410),rti)
#    elif integer_rdr == 5:
#        rectReg5txt=Text(Point(610,410),rdr)
    else :
        rectReg5txt=Text(Point(610,410),' ')
    rectReg5txt.setSize(8)
    rectReg5txt.draw(win2)
    ...
    if integer_rsi == 6:
        rectReg6txt=Text(Point(610,430),rsi)
    elif integer_rti == 6:
        rectReg6txt=Text(Point(610,430),rti)
#    elif integer_rdr == 6:
#        rectReg6txt=Text(Point(610,430),rdr)
    else :
        rectReg6txt=Text(Point(610,430),' ')
    rectReg6txt.setSize(8)
    rectReg6txt.draw(win2)
    ...
    if integer_rsi == 7:
        rectReg7txt=Text(Point(610,450),rsi)
    elif integer_rti == 7:
        rectReg7txt=Text(Point(610,450),rti)
#    elif integer_rdr == 7:
#        rectReg7txt=Text(Point(610,450),rdr)
    else :
        rectReg7txt=Text(Point(610,450),' ')
    rectReg7txt.setSize(8)
    rectReg7txt.draw(win2)
    ...
    if integer_rsi == 8:
        rectReg8txt=Text(Point(610,470),rsi)
    elif integer_rti == 8:
        rectReg8txt=Text(Point(610,470),rti)
#    elif integer_rdr == 8:
#        rectReg8txt=Text(Point(610,470),rdr)
    else :
        rectReg8txt=Text(Point(610,470),' ')
    rectReg8txt.setSize(8)
    rectReg8txt.draw(win2)
    ...
    if integer_rsi == 9:
        rectReg9txt=Text(Point(610,490),rsi)
    elif integer_rti == 9:
        rectReg9txt=Text(Point(610,490),rti)
#    elif integer_rdr == 9:
#        rectReg9txt=Text(Point(610,490),rdr)
    else :
        rectReg9txt=Text(Point(610,490),' ')
    rectReg9txt.setSize(8)
    rectReg9txt.draw(win2)
    ...
    if integer_rsi == 10:
        rectReg10txt=Text(Point(610,510),rsi)
    elif integer_rti == 10:
        rectReg10txt=Text(Point(610,510),rti)
#    elif integer_rdr == 10:
#        rectReg10txt=Text(Point(610,510),rdr)
    else :
        rectReg10txt=Text(Point(610,510),' ')
    rectReg10txt.setSize(8)
    rectReg10txt.draw(win2)
    ...
    if integer_rsi == 11:
        rectReg11txt=Text(Point(610,530),rsi)
    elif integer_rti == 11:
        rectReg11txt=Text(Point(610,530),rti)
#    elif integer_rdr == 11:
#        rectReg11txt=Text(Point(610,530),rdr)
    else :
        rectReg11txt=Text(Point(610,530),' ')
    rectReg11txt.setSize(8)
    rectReg11txt.draw(win2)
    ...
    if integer_rsi == 12:
        rectReg12txt=Text(Point(610,550),rsi)
    elif integer_rti == 12:
        rectReg12txt=Text(Point(610,550),rti)
#    elif integer_rdr == 12:
#        rectReg12txt=Text(Point(610,550),rdr)
    else :
        rectReg12txt=Text(Point(610,550),' ')
    rectReg12txt.setSize(8)
    rectReg12txt.draw(win2)
    ...
    if integer_rsi == 13:
        rectReg13txt=Text(Point(610,570),rsi)
    elif integer_rti == 13:
        rectReg13txt=Text(Point(610,570),rti)
#    elif integer_rdr == 13:
#        rectReg13txt=Text(Point(610,570),rdr)
    else :
        rectReg13txt=Text(Point(610,570),' ')
    rectReg13txt.setSize(8)
    rectReg13txt.draw(win2)
    ...
    if integer_rsi == 14:
        rectReg14txt=Text(Point(610,590),rsi)
    elif integer_rti == 14:
        rectReg14txt=Text(Point(610,590),rti)
#    elif integer_rdr == 14:
#        rectReg14txt=Text(Point(610,590),rdr)
    else :
        rectReg14txt=Text(Point(610,590),' ')
    rectReg14txt.setSize(8)
    rectReg14txt.draw(win2)
    ...
    if integer_rsi == 15:
        rectReg15txt=Text(Point(610,610),rsi)
    elif integer_rti == 15:
        rectReg15txt=Text(Point(610,610),rti)
#    elif integer_rdr == 15:
#        rectReg15txt=Text(Point(610,610),rdr)
    else :
        rectReg15txt=Text(Point(610,610),' ')
    rectReg15txt.setSize(8)
    rectReg15txt.draw(win2)
    ...
    #faz4  sign extention
    Line(Point(430,550),Point(430,750)).draw(win2)
    Line(Point(430,750),Point(500,750)).draw(win2)
    ...
    signOtxt.draw(win2)
    Line(Point(700,750),Point(760,750)).draw(win2)
    ...
    Line(Point(250,110),Point(800,110)).draw(win2) #az adder1 miad
    Line(Point(760,750),Point(760,270)).draw(win2)
    ...
    sll2txt.setSize(8)
    sll2txt.draw(win2)
    Line(Point(760,200),Point(760,130)).draw(win2)
    Line(Point(760,130),Point(800,130)).draw(win2)
    ...
    #Output adder2
    Line(Point(740,110),Point(740,65)).draw(win2)
    Line(Point(740,65),Point(900,65)).draw(win2)
    Line(Point(900,65),Point(900,100)).draw(win2)
    Line(Point(900,100),Point(940,100)).draw(win2)
    Line(Point(845,120),Point(940,120)).draw(win2)
    ...
    mux3txt.setFill('lime green')
    mux3txt.draw(win2)
    Line(Point(970,110),Point(1070,110)).draw(win2) 
    Line(Point(1070,110),Point(1070,40)).draw(win2)
    Line(Point(1070,40),Point(25,40)).draw(win2)
    
    
    #faz6 output line register file
    Line(Point(735,350),Point(900,350)).draw(win2)
    ...
    Line(Point(735,410),Point(813,410)).draw(win2)
    Line(Point(760,440),Point(810,440)).draw(win2)
    ...
    Mux2txt3.draw(win2)
    Line(Point(850,435),Point(900,435)).draw(win2) #vorodi alu
    Line(Point(790,410),Point(790,600)).draw(win2)
    Line(Point(790,600),Point(1030,600)).draw(win2) #vorodi2 mem
    ...
    #output Alu
    Line(Point(960,400),Point(1030,400)).draw(win2)
    ...
    #multiplxer2
    Line(Point(1120,550),Point(1180,550)).draw(win2)
    Line(Point(990,400),Point(990,700)).draw(win2)
    Line(Point(990,700),Point(1150,700)).draw(win2)
    Line(Point(1150,700),Point(1150,580)).draw(win2)
    Line(Point(1150,580),Point(1180,580)).draw(win2)
    ...
    #output mux2
    Line(Point(1210,565),Point(1250,565)).draw(win2)
    Line(Point(1250,565),Point(1250,810)).draw(win2)
    Line(Point(1250,810),Point(410,810)).draw(win2)
    Line(Point(410,810),Point(410,655)).draw(win2)
    Line(Point(410,655),Point(480,655)).draw(win2)
    #t5='writback='+str(rdr)
