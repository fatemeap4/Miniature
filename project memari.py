...
for line in file:
    ...
    list.append(line)
print(list)
register_file = [100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115]
b_register_file = []  #register file list 32_bit
memory = [0]*65535
memory[102]=1234   ##test_case
memory[103] = 5678 ##test_case
memory[101] = 9876 ##test_case
...
#def zero_Extention(of):
 #   of = str(of)
  #  of = "0000000000000000"+of
   # return of
...
def R_Type(x) :
    ...
    GUIR(x,integer_rsr,integer_rtr,integer_rdr,b_in_rsr,b_in_rtr,b_in_rdr)
    sleep(2)
        ...
        if in_rsi == in_rti :
            for index , each in enumerate(list):
                ...
                if branch[4:8] == "0000" or branch[4:8] == "0001" or branch[4:8] == "0010" or branch[4:8] == "0011" or branch[4:8] == "0100" :
                    ...
                    rdr = each[16:20]
                    R_Type(each)
                elif branch[4:8] == "1101" or branch[4:8] == "1110":
                    #J_Type
                    offsetj = each[16:]
                    J_Type()
...
for index,each in enumerate(list):
    ...
    elif op == "0101" or op == "0110" or op == "0111" or op == "1000" or op == "1001" or op == "1010" or op == "1011" or op == "1100":
        #I_Type
        rsi = each[8:12]
        rti = each[12:16]
        offseti = each[16:]
